...
- **[`docs/usage.md`](docs/usage.md)** — end-user guide for the 0.2.0 API, organized by topic with worked examples (constructors, segmentation, normalization, case, comparison, search, scripts, indices, errors).
- Auto-generated reference: `make docs` runs `pony-doc` over every public docstring.
- [`design/candidate-v3.md`](design/candidate-v3.md) — the design document the implementation derives from.
